...
<body>
    ...
    <header class="header">
      <nav class="navbar navbar-expand-lg">
        <div class="container"><a href="index-2.html" class="navbar-brand"><img src="{{asset("assets/images/nitda-logo-png.png")}}" alt="logo" class="d-none d-lg-block"><img src="../../../d19m59y37dris4.cloudfront.net/jobs/2-0-1/img/logo-small.png" alt="logo" class="d-block d-lg-none"><span class="sr-only">Go to homepage</span></a>
